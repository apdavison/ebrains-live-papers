...
export default function Develop({ navigateTo: _navigateTo }: Props) {
  return (
    <div>
      <div
        style={{
      ...
      <div className="block">
        ...
        <div className="block-text">
          ...
          ). The web interface uses this API behind the scenes, and it can also
          be used from any other website or with another programming language.
        </div>
      </div>
      ...
      <div className="block">
        ...
        <div className="block-text">
          If you need more fine-grained access than is available through the REST
          API, you may be able to access the underlying metadata in the EBRAINS
          Knowledge Graph directly using the{" "}
          <a
          ...
          library. Please{" "}
          <a href="mailto:support@ebrains.eu">contact us</a> to request access.
        </div>
      </div>
      ...
      <div className="block">
        ...
        <div className="block-text">
          EBRAINS Live Papers is an open-source project. You can find the source
          code and other development related info on{" "}
          <a

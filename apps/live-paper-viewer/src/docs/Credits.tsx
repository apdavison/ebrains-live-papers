...
export default function Credits({ navigateTo: _navigateTo }: Props) {
  return (
    <div>
      <div
        style={{
              ...
              <div style={{ lineHeight: 1.75 }}>
                ...
                <ul>
                  <li>
                    Shailesh Appukuttan
                    <br />
                    <i>Université Paris-Saclay, CNRS - France</i>
                  </li>
                  <li>
                    Andrew Davison
                    <br />
                  ...
                  <li>
                    Luca L. Bologna
                    <br />
                    <i>Institute of Biophysics, CNR - Italy</i>
                  </li>
                  <li>
                    Michele Migliore
                    <br />
                  ...
                  <li>
                    Felix Schürmann
                    <br />
                    <i>Blue Brain Project, EPFL - Switzerland</i>
                  </li>
                </ul>
              </div>
              <br />
              ...
              <div style={{ lineHeight: 1.75 }}>
                <ul>
                  <li>
                    ...
                    <i>
                      <a
                        href="https://neuroinformatics.nl/HBP/morphology-viewer/"
                        target="_blank"
                  ...
                  <li>
                    Genrich Ivaska, Stefano Antonel
                    <br />
                    <i>
                      <a
                        href="https://blue-naas-bsp-epfl.apps.hbp.eu/"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                  ...
                  <li>
                    Onur Ates, Andrew Davison, Shailesh Appukuttan
                    <br />
                    <i>
                      <a
                  ...
                  <li>
                    Shailesh Appukuttan, Andrew Davison
                    <br />
                    <i>
                      <a
                  ...
                  <li>
                    Fatma El Haddad, Shailesh Appukuttan
                    <br />
                    <i>CORS Proxy</i>
                  </li>
                </ul>

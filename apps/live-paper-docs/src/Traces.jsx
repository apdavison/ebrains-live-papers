      ...
      <div>
        ...
        >
          <div className="title-solid-style" style={{ fontSize: 44 }}>
            Resource Type: Electrophysiological Data
          </div>
          <div
        ...
        <div className="block">
          ...
          <div className="block-main-header">
            Sharing electrophysiology related resources
          </div>
          <div className="block-text">
            ...
            <br />
            <br />
            Authors can import / link existing electrophysiological data related
            entries from other repositories such as:
            <ul>
              <li>
                <a
              ...
              <li>
                <a
                  href="https://celltypes.brain-map.org/data/"
                  target="_blank"
                  rel="noreferrer"
                >
                  Allen Brain Atlas
        ...
        <div className="block">
          ...
          <div className="block-main-header">
            Accessing electrophysiology related resources
          </div>
          <div className="block-text">
            An example of a electrophysiology related resource section in a live

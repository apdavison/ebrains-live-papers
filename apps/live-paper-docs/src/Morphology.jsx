...
export default class Morphology extends React.Component {
  render() {
    return (
      <div>
        <div
        ...
        <div className="block">
          ...
          <div className="block-main-header">
            Sharing morphology related resources
          </div>
        ...
        <div className="block">
          ...
          <div className="block-main-header">
            Accessing morphology related resources
          </div>
          <div className="block-text">

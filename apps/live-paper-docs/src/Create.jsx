      ...
      <div>
        ...
        <div className="block">
          ...
          <div className="block-main-header">
            Create interactive live papers online
          </div>
          <div className="block-text">
            ...
            repositories, such as ModelDB, OSB, BioModels, NeuroMorpho and the
            Allen Brain Atlas, resources already hosted on these platforms are
            not duplicated, but instead we provide redirects to the
            corresponding entries on these platforms
          </div>
        </div>
      </div>
    );

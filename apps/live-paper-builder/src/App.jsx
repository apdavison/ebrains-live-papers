    ...
    return (
      ...
      <div className="mycontainer" style={{ textAlign: "left" }}>
        ...
        >
          ...
          <br />
          Here you can start building a new live paper, which may optionally be linked to a preprint or published article.
          The live paper builder allows you to build the live paper without any web development skills.
          Various functionalities for building a simple to moderately complex live paper are made available via this tool.
          For more advanced features and customizations, contact support for guidance.
          <br />
          <br />
          Live papers are often not produced in one go, and might require revisions over time. Keeping this in
          mind, "live paper projects" can be downloaded at any point of development. These project
          files can be loaded later, to continue from where you had left off. Alternatively,
          projects can also be saved to/loaded from the EBRAINS Knowledge Graph.
          <br />
          <br />
          <div
            style={{
